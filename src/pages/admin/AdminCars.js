...
const AdminCars = () => {
  ...
  const handleUpdateCar = async (formData) => {
    try {
      ...
      const carResponse = await fetch(`${API_BASE_URL}/cars/${editingCar.id}`, {
        method: 'PUT',
        headers: {
      ...
      setEditingCar(null);
      window.location.reload(); // Refresh to show updated car
    } catch (err) {
        ...
        <div className="row">
          <div className="col-12">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <SubmitButton onClick={() => setShowAddModal(true)}>
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            ...
            <SubmitButton type="submit" loading={uploading}>
...
const EditCarModal = ({ car, onClose, onSubmit, uploading }) => {
  const [formData, setFormData] = useState({
    brand: car.brand || '',
    model: car.model || '',
    type: car.type || '',
    ...
    total_quantity: car.total_quantity || '1',
    customQuantity: '',
    imageFile: null
  });
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h4 style={{ color: 'white', marginBottom: '20px' }}>Edit Car - {car.brand} {car.model}</h4>
            ...
            <div className="col-12 mb-3">
              ...
              {car.image_url && (
                <div style={{ marginTop: '10px' }}>
                  <small style={{ color: '#ccc' }}>Current image:</small>
                  <img 
                    src={car.image_url} 
                    alt="Current car" 
                    style={{ width: '100px', height: '60px', objectFit: 'cover', borderRadius: '4px', marginLeft: '10px' }}
                  />
                </div>
              )}
            </div>
